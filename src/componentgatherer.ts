...
/**
 * Gather any components on the current page. This is safe to call multiple times, since anything this finds will be removed
 * from the document. If you add more content dynamically you can call this function to discover any component templates on it.
 */
export function gatherComponents() {
